...
asset_entry =  pacioli.models.AccountTypes(name = 'Asset')
pacioli.db.session.add(asset_entry)
liability_entry =  pacioli.models.AccountTypes(name = 'Liability')
pacioli.db.session.add(liability_entry)
equity_entry =  pacioli.models.AccountTypes(name = 'Equity')
pacioli.db.session.add(equity_entry)
revenue_entry =  pacioli.models.AccountTypes(name = 'Revenue')
pacioli.db.session.add(revenue_entry)
expense_entry =  pacioli.models.AccountTypes(name = 'Expense')
